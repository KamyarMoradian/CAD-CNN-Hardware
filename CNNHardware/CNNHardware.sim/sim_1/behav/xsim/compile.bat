...
REM
REM Generated by Vivado on Tue Jan 24 22:35:53 +0330 2023
...
echo "xvhdl --incr --relax -prj Accelerator_vhdl.prj"
call xvhdl  --incr --relax -prj Accelerator_vhdl.prj -log xvhdl.log
